...
# PART 1: Directory to search for index.html files
# DIR="."
...
#   # Replace line 729 with the content of the value variable
#   sed -i '' "729s|.*|$value|" "$file"
  
#   echo "Updated line 729 in $file"
# done

# PART 2: Directory to search for index.html files
#!/bin/bash

# JSON file containing translations
TRANSLATION_FILE="languages-demoVideos.json"
